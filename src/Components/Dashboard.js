    ...
    <div className="flex">
     <div className=" mt-7 ml-14 ">
      <div className="w-64 h-64 flex flex-col items-center justify-center bg-neutral-200 rounded-2xl ">
        ...
        <strong className="pt-8">Adminstrator</strong>
        <p className="pt-5">ID:1232455</p>
      </div>
      <div className=" flex flex-col items-center  w-64 rounded-2xl mt-10 h-[440px] bg-neutral-200">
        <strong className="h-10 flex justify-center items-center mt-7 w-60  bg-neutral-600 text-white rounded-2xl">
          Dashbord
        </strong>
        {
          <div className="  mt-10 mb-10  flex flex-col gap-y-10">
